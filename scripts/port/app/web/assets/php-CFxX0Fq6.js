...
import { r as requireHtmlmixed } from "./htmlmixed-Bk7ctqpJ.js";
import { r as requireClike } from "./clike-Csx-B8on.js";
      ...
      CodeMirror2.defineMode("php", function(config, parserConfig) {
        ...
        return {
          startState: function() {
            ...
            var php2 = parserConfig.startOpen ? CodeMirror2.startState(phpMode) : null;
            return {
              html,
              php: php2,
              curMode: parserConfig.startOpen ? phpMode : htmlMode,
              curState: parserConfig.startOpen ? php2 : html,
              pending: null
            };
          },
          copyState: function(state) {
            var html = state.html, htmlNew = CodeMirror2.copyState(htmlMode, html), php2 = state.php, phpNew = php2 && CodeMirror2.copyState(phpMode, php2), cur;
