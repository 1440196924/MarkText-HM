...
var flowchart_shim = {};
var hasRequiredFlowchart_shim;
function requireFlowchart_shim() {
  if (hasRequiredFlowchart_shim) return flowchart_shim;
  hasRequiredFlowchart_shim = 1;
  ...
  return flowchart_shim;
}
var raphael_min = { exports: {} };
var hasRequiredRaphael_min;
function requireRaphael_min() {
  if (hasRequiredRaphael_min) return raphael_min.exports;
  hasRequiredRaphael_min = 1;
  ...
  return raphael_min.exports;
}
var flowchart_helpers;
var hasRequiredFlowchart_helpers;
function requireFlowchart_helpers() {
  if (hasRequiredFlowchart_helpers) return flowchart_helpers;
  hasRequiredFlowchart_helpers = 1;
  ...
  return flowchart_helpers;
}
var flowchart_defaults;
var hasRequiredFlowchart_defaults;
function requireFlowchart_defaults() {
  if (hasRequiredFlowchart_defaults) return flowchart_defaults;
  hasRequiredFlowchart_defaults = 1;
  flowchart_defaults = {
    "x": 0,
    "y": 0,
    // 'roundness': 0,
  ...
  return flowchart_defaults;
}
var flowchart_functions;
var hasRequiredFlowchart_functions;
function requireFlowchart_functions() {
  if (hasRequiredFlowchart_functions) return flowchart_functions;
  hasRequiredFlowchart_functions = 1;
  ...
  return flowchart_functions;
}
var flowchart_symbol;
var hasRequiredFlowchart_symbol;
function requireFlowchart_symbol() {
  if (hasRequiredFlowchart_symbol) return flowchart_symbol;
  hasRequiredFlowchart_symbol = 1;
  var drawAPI = requireFlowchart_functions();
  ...
  flowchart_symbol = Symbol2;
  return flowchart_symbol;
}
var flowchart_symbol_condition;
var hasRequiredFlowchart_symbol_condition;
function requireFlowchart_symbol_condition() {
  if (hasRequiredFlowchart_symbol_condition) return flowchart_symbol_condition;
  hasRequiredFlowchart_symbol_condition = 1;
  var Symbol2 = requireFlowchart_symbol();
  var inherits = requireFlowchart_helpers().inherits;
  var drawAPI = requireFlowchart_functions();
  ...
  flowchart_symbol_condition = Condition;
  return flowchart_symbol_condition;
}
var flowchart_symbol_parallel;
var hasRequiredFlowchart_symbol_parallel;
function requireFlowchart_symbol_parallel() {
  if (hasRequiredFlowchart_symbol_parallel) return flowchart_symbol_parallel;
  hasRequiredFlowchart_symbol_parallel = 1;
  var Symbol2 = requireFlowchart_symbol();
  var inherits = requireFlowchart_helpers().inherits;
  ...
  flowchart_symbol_parallel = Parallel;
  return flowchart_symbol_parallel;
}
var flowchart_chart;
var hasRequiredFlowchart_chart;
function requireFlowchart_chart() {
  if (hasRequiredFlowchart_chart) return flowchart_chart;
  hasRequiredFlowchart_chart = 1;
  var Raphael = requireRaphael_min();
  var defaults = requireFlowchart_helpers().defaults;
  var defaultOptions = requireFlowchart_defaults();
  var Condition = requireFlowchart_symbol_condition();
  var Parallel = requireFlowchart_symbol_parallel();
  ...
  flowchart_chart = FlowChart;
  return flowchart_chart;
}
var flowchart_symbol_start;
var hasRequiredFlowchart_symbol_start;
function requireFlowchart_symbol_start() {
  if (hasRequiredFlowchart_symbol_start) return flowchart_symbol_start;
  hasRequiredFlowchart_symbol_start = 1;
  var Symbol2 = requireFlowchart_symbol();
  var inherits = requireFlowchart_helpers().inherits;
  ...
  flowchart_symbol_start = Start;
  return flowchart_symbol_start;
}
var flowchart_symbol_end;
var hasRequiredFlowchart_symbol_end;
function requireFlowchart_symbol_end() {
  if (hasRequiredFlowchart_symbol_end) return flowchart_symbol_end;
  hasRequiredFlowchart_symbol_end = 1;
  var Symbol2 = requireFlowchart_symbol();
  var inherits = requireFlowchart_helpers().inherits;
  ...
  flowchart_symbol_end = End;
  return flowchart_symbol_end;
}
var flowchart_symbol_operation;
var hasRequiredFlowchart_symbol_operation;
function requireFlowchart_symbol_operation() {
  if (hasRequiredFlowchart_symbol_operation) return flowchart_symbol_operation;
  hasRequiredFlowchart_symbol_operation = 1;
  var Symbol2 = requireFlowchart_symbol();
  var inherits = requireFlowchart_helpers().inherits;
  ...
  flowchart_symbol_operation = Operation;
  return flowchart_symbol_operation;
}
var flowchart_symbol_inputoutput;
var hasRequiredFlowchart_symbol_inputoutput;
function requireFlowchart_symbol_inputoutput() {
  if (hasRequiredFlowchart_symbol_inputoutput) return flowchart_symbol_inputoutput;
  hasRequiredFlowchart_symbol_inputoutput = 1;
  var Symbol2 = requireFlowchart_symbol();
  var inherits = requireFlowchart_helpers().inherits;
  var drawAPI = requireFlowchart_functions();
  var drawPath = drawAPI.drawPath;
  ...
  flowchart_symbol_inputoutput = InputOutput;
  return flowchart_symbol_inputoutput;
}
var flowchart_symbol_input;
var hasRequiredFlowchart_symbol_input;
function requireFlowchart_symbol_input() {
  if (hasRequiredFlowchart_symbol_input) return flowchart_symbol_input;
  hasRequiredFlowchart_symbol_input = 1;
  var Symbol2 = requireFlowchart_symbol();
  var inherits = requireFlowchart_helpers().inherits;
  var drawAPI = requireFlowchart_functions();
  var drawPath = drawAPI.drawPath;
  ...
  flowchart_symbol_input = Input;
  return flowchart_symbol_input;
}
var flowchart_symbol_output;
var hasRequiredFlowchart_symbol_output;
function requireFlowchart_symbol_output() {
  if (hasRequiredFlowchart_symbol_output) return flowchart_symbol_output;
  hasRequiredFlowchart_symbol_output = 1;
  var Symbol2 = requireFlowchart_symbol();
  var inherits = requireFlowchart_helpers().inherits;
  var drawAPI = requireFlowchart_functions();
  var drawPath = drawAPI.drawPath;
  ...
  flowchart_symbol_output = Output;
  return flowchart_symbol_output;
}
var flowchart_symbol_subroutine;
var hasRequiredFlowchart_symbol_subroutine;
function requireFlowchart_symbol_subroutine() {
  if (hasRequiredFlowchart_symbol_subroutine) return flowchart_symbol_subroutine;
  hasRequiredFlowchart_symbol_subroutine = 1;
  var Symbol2 = requireFlowchart_symbol();
  var inherits = requireFlowchart_helpers().inherits;
  ...
  flowchart_symbol_subroutine = Subroutine;
  return flowchart_symbol_subroutine;
}
var flowchart_parse;
var hasRequiredFlowchart_parse;
function requireFlowchart_parse() {
  if (hasRequiredFlowchart_parse) return flowchart_parse;
  hasRequiredFlowchart_parse = 1;
  var FlowChart = requireFlowchart_chart();
  var Start = requireFlowchart_symbol_start();
  var End = requireFlowchart_symbol_end();
  var Operation = requireFlowchart_symbol_operation();
  var InputOutput = requireFlowchart_symbol_inputoutput();
  var Input = requireFlowchart_symbol_input();
  var Output = requireFlowchart_symbol_output();
  var Subroutine = requireFlowchart_symbol_subroutine();
  var Condition = requireFlowchart_symbol_condition();
  var Parallel = requireFlowchart_symbol_parallel();
  ...
  flowchart_parse = parse;
  return flowchart_parse;
}
var jqueryPlugin = {};
var hasRequiredJqueryPlugin;
function requireJqueryPlugin() {
  if (hasRequiredJqueryPlugin) return jqueryPlugin;
  hasRequiredJqueryPlugin = 1;
  if (typeof jQuery != "undefined") {
    var parse = requireFlowchart_parse();
    (function($) {
...
var flowchart_js;
var hasRequiredFlowchart_js;
function requireFlowchart_js() {
  if (hasRequiredFlowchart_js) return flowchart_js;
  hasRequiredFlowchart_js = 1;
  requireFlowchart_shim();
  var parse = requireFlowchart_parse();
  requireJqueryPlugin();
  var FlowChart = {
    parse
  ...
  flowchart_js = FlowChart;
  return flowchart_js;
}
var flowchart_jsExports = requireFlowchart_js();
const index = /* @__PURE__ */ getDefaultExportFromCjs(flowchart_jsExports);
